     ...
     function removeGame(){
      ...
      game
       ...
       function watchAds() {
          ...
          const gameName = document.getElementById("gn");
          ...
          function playadIframe() {
            ...
            var duration = getFieldFromCollection(document.getElementById("adIframe").src);
            timer = setTimeout(() => {
              handleAdCompletion();
            }, duration*60*1000);
          }
      ...
      // Assuming you have initialized the Firebase Firestore
       const gamesCollection = firebase.firestore().collection('gameRef');
        ...
        function calculateRevenue(){
          ...
          rev = (Number(getFieldAFromCollection(adIframe.src)) * 2) + 0.45;
          return rev;
        }
